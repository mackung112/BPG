  ...
  return (
    <div className="font-sans text-slate-800 pb-24 selection:bg-rose-200 selection:text-rose-900 relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-5%] left-[-10%] w-[45vw] h-[45vw] rounded-full bg-rose-200/40 blur-[160px]"></div>
        <div className="absolute bottom-[10%] right-[-5%] w-[40vw] h-[40vw] rounded-full bg-pink-200/35 blur-[160px]"></div>
      </div>
