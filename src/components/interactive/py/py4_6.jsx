  ...
  return (
    <div className="font-sans text-slate-800 pb-24 selection:bg-violet-200 selection:text-violet-900">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[5%] right-[-5%] w-[45vw] h-[45vw] rounded-full bg-violet-100/60 blur-[120px]"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[40vw] h-[40vw] rounded-full bg-indigo-50/70 blur-[100px]"></div>
      </div>
