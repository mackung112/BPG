...
export default function os11_1() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pt-6 pb-20 space-y-12 md:space-y-16">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white/60 backdrop-blur-xl border border-white/40 shadow-xl rounded-2xl p-6 border-l-[4px] border-l-indigo-500 hover:-translate-y-1 transition-all duration-300">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-3 rounded-2xl bg-indigo-50/80 text-indigo-600 shadow-inner">
                  <ShieldAlert size={24} />
                </div>
                <h4 className="text-lg font-semibold text-slate-800">1. UAC & Administrator Mode</h4>
              </div>
            ...
            <div className="bg-white/60 backdrop-blur-xl border border-white/40 shadow-xl rounded-2xl p-6 border-l-[4px] border-l-cyan-500 hover:-translate-y-1 transition-all duration-300">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-3 rounded-2xl bg-cyan-50/80 text-cyan-600 shadow-inner">
                  <Terminal size={24} />
                </div>
                <h4 className="text-lg font-semibold text-slate-800">2. SFC (System File Checker)</h4>
              </div>
              <p className="text-slate-600 text-[16px] leading-relaxed">
            ...
            <div className="bg-white/60 backdrop-blur-xl border border-white/40 shadow-xl rounded-2xl p-6 border-l-[4px] border-l-orange-500 hover:-translate-y-1 transition-all duration-300">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-3 rounded-2xl bg-orange-50/80 text-orange-600 shadow-inner">
                  <Search size={24} />
                </div>
                <h4 className="text-lg font-semibold text-slate-800">3. Log Analysis</h4>
              </div>
              <p className="text-slate-600 text-[16px] leading-relaxed">
            ...
            <div className="bg-white/60 backdrop-blur-xl border border-white/40 shadow-xl rounded-2xl p-6 border-l-[4px] border-l-emerald-500 hover:-translate-y-1 transition-all duration-300 lg:col-span-1 md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-3 rounded-2xl bg-emerald-50/80 text-emerald-600 shadow-inner">
                  <HardDrive size={24} />
                </div>
                <h4 className="text-lg font-semibold text-slate-800">4. Check Disk (CHKDSK)</h4>
              </div>
              <p className="text-slate-600 text-[16px] leading-relaxed">
            ...
            <div className="bg-white/60 backdrop-blur-xl border border-white/40 shadow-xl rounded-2xl p-6 border-l-[4px] border-l-blue-500 hover:-translate-y-1 transition-all duration-300 lg:col-span-2 md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-3 rounded-2xl bg-blue-50/80 text-blue-600 shadow-inner">
                  <Activity size={24} />
                </div>
                <h4 className="text-lg font-semibold text-slate-800">5. Task Manager Monitor</h4>
              </div>
              <p className="text-slate-600 text-[16px] leading-relaxed">
          ...
          <div className="p-6 md:p-8 min-h-[400px]">
            ...
            {activeTab === 0 && (
              <div className="flex flex-col md:flex-row gap-8">
                <div className="w-full md:w-1/3 space-y-4">
                  <p className="text-slate-300 text-[16px]">ทดลองเปิด Command Prompt ทั้ง 2 โหมด เพื่อดูความแตกต่างของสิทธิ์การใช้งาน</p>
                  
                  <button 
                    onClick={() => setUacState('user_cmd')}
                    className="w-full flex items-center justify-between p-4 rounded-xl bg-slate-800/80 border border-slate-700 hover:border-slate-500 text-left transition-all cursor-pointer"
                  >
                    <div>
                      <h5 className="text-white font-medium">เปิดแบบปกติ (User)</h5>
                      <span className="text-slate-400 text-sm">รันด้วยสิทธิ์ผู้ใช้ทั่วไป</span>
                    </div>
                  ...
                  <button 
                    ...
                    className="w-full flex items-center justify-between p-4 rounded-xl bg-indigo-900/40 border border-indigo-500/50 hover:border-indigo-400 text-left transition-all cursor-pointer"
                  >
                    <div>
                      <h5 className="text-indigo-300 font-medium">เปิดแบบ Admin</h5>
                      <span className="text-slate-400 text-sm">รันด้วยสิทธิ์ผู้ดูแลระบบ</span>
                    </div>
                  ...
                  <button 
                    ...
                    className="w-full text-center py-2 text-slate-500 hover:text-white text-sm cursor-pointer transition-colors"
                  >
                    <RotateCcw size={16} className="inline mr-2" /> รีเซ็ต
                  </button>
                </div>

                <div className="w-full md:w-2/3 flex items-center justify-center bg-black/30 rounded-xl border border-white/5 p-4 relative">
                  {uacState === 'idle' && (
                    <div className="text-slate-500 text-center">
                      <Terminal size={48} className="mx-auto mb-4 opacity-50" />
                      <p>เลือกโหมดเพื่อจำลองการเปิดโปรแกรม</p>
                    </div>
                  )}

                  {uacState === 'user_cmd' && (
                    <div className="w-full h-full bg-black text-slate-300 font-mono text-sm p-4 rounded-lg font-mono">
                      <div>Microsoft Windows [Version 10.0.19045.3803]</div>
                      <div>(c) Microsoft Corporation. All rights reserved.</div>
                      <br/>
                      <div className="text-emerald-400">C:\Users\Student&gt; sfc /scannow</div>
                      <div className="text-red-400 mt-2">You must be an administrator running a console session in order to use the sfc utility.</div>
                    </div>
                  )}
                  ...
                  {uacState === 'admin_prompt' && (
                    <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-10 rounded-xl">
                      <div className="bg-slate-200 w-[400px] p-6 rounded-lg shadow-2xl border-t-[6px] border-yellow-500">
                        <div className="flex gap-4">
                          <ShieldAlert size={40} className="text-yellow-600" />
                          <div>
                            <h3 className="text-slate-900 font-medium text-lg">User Account Control</h3>
                            <p className="text-slate-700 text-sm mt-2 mb-6">Do you want to allow this app to make changes to your device?</p>
                            <p className="font-bold text-slate-900 text-sm">Windows Command Processor</p>
                          </div>
                        </div>
                        <div className="flex justify-end gap-3 mt-4">
                          <button onClick={() => setUacState('admin_cmd')} className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded font-medium cursor-pointer">Yes</button>
                          <button onClick={() => setUacState('idle')} className="px-6 py-2 bg-slate-300 hover:bg-slate-400 text-slate-800 rounded font-medium cursor-pointer">No</button>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {uacState === 'admin_cmd' && (
                    <div className="w-full h-full bg-black text-slate-300 font-mono text-sm p-4 rounded-lg">
                      <div className="bg-white text-black px-2 inline-block mb-2 font-bold text-xs">Administrator: Command Prompt</div>
                      <div>Microsoft Windows [Version 10.0.19045.3803]</div>
                      <br/>
                      <div className="text-emerald-400">C:\Windows\System32&gt; _</div>
                    </div>
                  )}
                </div>
              </div>
            ...
            {activeTab === 1 && (
              <div className="flex flex-col h-full gap-4">
                <div className="flex gap-4 mb-2">
                  ...
                  {sfcState === 'complete' && (
                    <button 
                      ...
                      className="px-4 py-2 rounded-lg bg-slate-700 hover:bg-slate-600 text-white font-medium cursor-pointer"
                    >
                      <RotateCcw size={18} />
                    </button>
                  )}
                ...
                <div className="bg-black text-slate-300 font-mono text-sm p-6 rounded-xl flex-grow h-[300px] overflow-hidden">
            ...
            {activeTab === 2 && (
              <div className="flex flex-col md:flex-row gap-6">
                <div className="w-full md:w-1/2 space-y-3">
                  <h5 className="text-white font-medium mb-4">ผลลัพธ์จากการสแกน 4 รูปแบบ</h5>
                  ...
                  {[
                    ...
                    >
                      <h6 className="text-white font-medium text-[15px]">{res.title}</h6>
                      <p className="text-slate-400 text-xs mt-1 italic">"...{res.desc}"</p>
                    </button>
                  ))}
                </div>

                <div className="w-full md:w-1/2 bg-slate-800/80 rounded-xl border border-white/10 p-6 flex items-center justify-center">
                  {!selectedResult && (
                    <div className="text-slate-500 text-center">
                      <FileSearch size={48} className="mx-auto mb-4 opacity-50" />
                      <p>เลือกรูปแบบผลลัพธ์เพื่อดูคำแนะนำ</p>
                    </div>
                  )}
                  ...
                  {selectedResult === 'ok' && (
                    <div className="text-center">
                      ...
                      <h4 className="text-emerald-400 font-bold text-lg mb-2">ระบบสมบูรณ์ปกติ</h4>
                  ...
                  {selectedResult === 'fixed' && (
                    <div className="text-center">
                      ...
                      <h4 className="text-blue-400 font-bold text-lg mb-2">ซ่อมแซมเสร็จสิ้นอัตโนมัติ</h4>
                      <p className="text-slate-300 text-[16px] leading-relaxed">
                  ...
                  {selectedResult === 'fail' && (
                    <div className="text-center">
                      ...
                      <h4 className="text-red-400 font-bold text-lg mb-2">ไฟล์เสียหายระดับลึก (ซ่อมไม่ได้)</h4>
                      ...
                      <div className="bg-black/40 p-3 rounded text-sm text-left border-l-4 border-red-500">
                        <strong className="text-white block mb-1">วิธีแก้ปัญหา:</strong>
                        1. รันคำสั่ง DISM: <code className="text-orange-300">DISM /Online /Cleanup-Image /RestoreHealth</code><br/>
                  ...
                  {selectedResult === 'error' && (
                    <div className="text-center">
                      ...
                      <h4 className="text-orange-400 font-bold text-lg mb-2">สแกนไม่สำเร็จ (ติดขัด)</h4>
                      <p className="text-slate-300 text-[16px] leading-relaxed">
            ...
            {activeTab === 3 && (
               <div className="flex flex-col h-full gap-4">
                 ...
                 <div className="bg-black text-slate-300 font-mono text-[13px] p-6 rounded-xl flex-grow h-[350px] overflow-y-auto">
                   ...
                   {chkdskState !== 'idle' && (
                     <div className="mt-4 text-slate-400 space-y-2">
                       ...
                       {chkdskLogs.map((log, i) => (
                         <div key={i} className={log.includes('found no problems') ? 'text-emerald-400 font-bold mt-4' : 'text-slate-400'}>
                           {log}
                         </div>
                       ))}
            ...
            {activeTab === 4 && (
              <div className="flex flex-col gap-4">
                <div className="flex gap-4 items-end mb-4">
                  <div className="flex-1 bg-black/40 border border-white/10 rounded-xl p-4">
                    ...
                    <div className="flex items-end gap-3">
                      <div className={`text-3xl font-bold ${cpuUsage > 80 ? 'text-red-400' : 'text-blue-400'}`}>
                        {Math.round(cpuUsage)}%
                      </div>
                      <div className="flex-1 h-8 bg-slate-800 rounded overflow-hidden flex items-end">
                        <div 
                  ...
                  <div className="flex-1 bg-black/40 border border-white/10 rounded-xl p-4">
                    ...
                    <div className="flex items-end gap-3">
                      <div className={`text-3xl font-bold ${memoryUsage > 85 ? 'text-orange-400' : 'text-emerald-400'}`}>
                ...
                <div className="bg-white text-slate-800 rounded-xl overflow-hidden font-sans">
                  <div className="bg-slate-100 px-4 py-2 text-xs font-semibold text-slate-500 grid grid-cols-12 gap-4 border-b">
                    ...
                    {processes.map(p => (
                      <div key={p.id} className={`px-4 py-3 text-sm grid grid-cols-12 gap-4 items-center ${p.id === 3 ? 'bg-orange-50' : ''}`}>
                        <div className="col-span-6 font-medium flex items-center gap-2">
                          {p.name}
                          {p.id === 3 && <span className="bg-red-100 text-red-700 px-2 py-0.5 rounded text-[10px] font-bold uppercase">High Usage</span>}
                        </div>
                        <div className={`col-span-2 text-right font-mono ${p.id === 3 ? 'text-red-600 font-bold' : ''}`}>
                          {p.id === 3 ? (cpuUsage * 0.75).toFixed(1) : p.cpu.toFixed(1)}%
                        </div>
                        <div className={`col-span-2 text-right font-mono ${p.id === 3 ? 'text-orange-600 font-bold' : ''}`}>
                          {p.memory} MB
                        </div>
                        <div className="col-span-2 text-right">
                          {p.id === 3 && (
                            <button 
                              ...
                              className="px-3 py-1 bg-slate-800 text-white text-xs rounded hover:bg-red-600 transition-colors cursor-pointer"
                            >
                              End Task
                            </button>
                          )}
                ...
                {taskManagerState === 'resolved' && (
                  <div className="bg-emerald-900/30 border border-emerald-500/30 text-emerald-400 px-4 py-3 rounded-lg flex items-center gap-3">
